...
[assembly: InternalsVisibleTo("Tuanjie.AndroidAppView")]
#endif
namespace UnityEngine.UI
{
    ...
    public static class DefaultControls
    {
        ...
        internal class DefaultRuntimeFactory : IFactoryControls
        {
        ...
        internal static GameObject CreateUIElementRoot(string name, Vector2 size, params Type[] components)
        {
