...
namespace TMPro
{
    ...
    public abstract class TMP_Text : MaskableGraphic
    {
        ...
        public bool enableAdvanceTextProcess
        {
            get { return m_enableAdvanceTextProcess; }
            set
            {
                if (m_enableAdvanceTextProcess == value) 
                    return; m_enableAdvanceTextProcess = value;
                m_havePropertiesChanged = true; 
                SetVerticesDirty(); SetLayoutDirty();
            }
        }
        [SerializeField]
        protected bool m_enableAdvanceTextProcess = false;
        ...
        ///
        /// </summary>
        internal virtual void PopulateTextProcessingArray()
        {
                    ...
                    else
                    {
                        switch (m_colorMode)
                        {
                            case ColorMode.Single:
                                m_fontColorGradient.topRight = m_fontColorGradient.topLeft;
                                m_fontColorGradient.bottomLeft = m_fontColorGradient.topLeft;
                                m_fontColorGradient.bottomRight = m_fontColorGradient.topLeft;
                                break;
                            case ColorMode.HorizontalGradient:
                                m_fontColorGradient.bottomLeft = m_fontColorGradient.topLeft;
                                m_fontColorGradient.bottomRight = m_fontColorGradient.topRight;
                                break;
                            case ColorMode.VerticalGradient:
                                m_fontColorGradient.topRight = m_fontColorGradient.topLeft;
                                m_fontColorGradient.bottomRight = m_fontColorGradient.bottomLeft;
                                break;
                        }
