...
namespace TMPro.EditorUtilities
{
    ...
    {
        //Labels and Tooltips
        static readonly GUIContent k_AdvanceTextProcessorToggleLabel = new GUIContent("Enable", "Using ICU4c & Harfbuzz to do advance text processing.");
        ...
        protected SerializedProperty m_EnableAdvanceTextProcessProp;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_EnableAdvanceTextProcessProp = serializedObject.FindProperty("m_enableAdvanceTextProcess");
        ...
        protected void DrawAdvanceTextProcessor()
        {
            ...
            GUI.Label(rect, new GUIContent("<b>Advance Text Processing</b>"), TMP_UIStyleManager.sectionHeader);

            float labelWidth = EditorGUIUtility.labelWidth;
            EditorGUIUtility.labelWidth = 110f;

            m_EnableAdvanceTextProcessProp.boolValue = EditorGUI.Toggle(new Rect(rect.width - 120, rect.y + 4, 120, 20), k_AdvanceTextProcessorToggleLabel, m_EnableAdvanceTextProcessProp.boolValue);

            EditorGUIUtility.labelWidth = labelWidth;
            EditorGUILayout.Space();
#else
            m_EnableAdvanceTextProcessProp.boolValue = false;
#endif
        }
        ...
        protected void DrawTextInput()
        {
            ...
            else
            {
                ...
                m_IsRightToLeftProp.boolValue = EditorGUI.Toggle(new Rect(rect.width - 120, rect.y + 4, 130, 20), k_RtlToggleLabel, m_IsRightToLeftProp.boolValue);
        ...
        void DrawColor()
        {
            ...
            if (m_EnableVertexGradientProp.boolValue)
            {
                ...
                if (!colorMode.hasMultipleDifferentValues)
                {
