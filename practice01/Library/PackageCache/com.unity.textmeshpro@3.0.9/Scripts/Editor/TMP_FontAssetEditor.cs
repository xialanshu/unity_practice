...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_FontAssetEditor : Editor
    {
        ...
        public void OnEnable()
        {
            ...
            if (m_fontAsset.m_SourceFontFile_EditorRef == null)
            {
                string path = UnityEditor.AssetDatabase.GUIDToAssetPath(m_fontAsset.m_SourceFontFileGUID);
                m_fontAsset.m_SourceFontFile_EditorRef = UnityEditor.AssetDatabase.LoadAssetAtPath<Font>(path);
            }
